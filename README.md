...
# Pizza Data Analysis SQL, Power BI Project
...
1. **Set up a Domino’s pizza database**: Create and populate the database with orders, order_details, pizzas, pizza_types.  
2. **Data Cleaning**: Identify and remove null or inconsistent records.  
3. **Exploratory Data Analysis (EDA)**: Understand daily trend,top/bottom sellers, order trends and menu performance.  
